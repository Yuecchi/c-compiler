/*******************************************************************************
*
* Parser generated by RDP on Jan 26 2021 18:14:54 from func.bnf
*
*******************************************************************************/
#include <time.h>
#include "arg.h"
...
/* Set declarations */
  ...
  set_ GLB_DECL_first = SET_NULL;
  set_ GLB_DECL_stop = SET_NULL;
  ...
  set_ rdp_GLB_DECL_2_first = SET_NULL;
...
RDP_T_27 /* < */, RDP_T_28 /* <= */, RDP_T_30 /* == */, RDP_T_31 /* > */, RDP_T_32 /* >= */,SET_END);
  ...
  set_assign_list(&GLB_BOOL_stop, SCAN_P_EOF, RDP_T_20 /* ) */, RDP_T_26 /* ; */,SET_END);
  set_assign_list(&GLB_DECL_first, RDP_T_26 /* ; */, RDP_T_29 /* = */, SET_END);
  set_assign_list(&GLB_DECL_stop, SCAN_P_EOF, RDP_T_int,SET_END);
  set_assign_list(&GLB_EXPR_first, SCAN_P_ID, SCAN_P_INTEGER, RDP_T_19 /* ( */, SET_END);
  set_assign_list(&GLB_EXPR_stop, SCAN_P_EOF, RDP_T_20 /* ) */, RDP_T_26 /* ; */,SET_END);
...
RDP_T_22 /* + */, RDP_T_24 /* - */, RDP_T_25 /* / */, RDP_T_26 /* ; */, RDP_T_30 /* == */,SET_END);
  set_assign_list(&GLB_PROD_first, SCAN_P_ID, SCAN_P_INTEGER, RDP_T_19 /* ( */, SET_END);
  set_assign_list(&GLB_PROD_stop, SCAN_P_EOF, RDP_T_17 /* != */, RDP_T_20 /* ) */, RDP_T_22 /* + */, RDP_T_24 /* - */, 
RDP_T_26 /* ; */, RDP_T_30 /* == */,SET_END);
  set_assign_list(&GLB_SUM_first, SCAN_P_ID, SCAN_P_INTEGER, RDP_T_19 /* ( */, SET_END);
  set_assign_list(&GLB_SUM_stop, SCAN_P_EOF, RDP_T_17 /* != */, RDP_T_20 /* ) */, RDP_T_26 /* ; */, RDP_T_30 /* == */,SET_END);
...
RDP_T_32 /* >= */, SET_END);
  ...
  set_assign_list(&rdp_GLB_DECL_2_first, RDP_T_26 /* ; */, RDP_T_29 /* = */, SET_END);
...
static int GLB_BOOL(void);
static void GLB_DECL(char* name);
static int GLB_EXPR(void);
static int GLB_PRIM(void);
static int GLB_PROD(void);
static int GLB_SUM(void);
...
static void GLB_DECL(char* name)
{
  int val;
  {
    ...
    if (scan_test(NULL, RDP_T_29 /* = */, NULL))
    { /* Start of rdp_GLB_DECL_1 */
      while (1)
      {
        {
          scan_test(NULL, RDP_T_29 /* = */, &GLB_DECL_stop);
          scan_();
          val = GLB_EXPR();
          }
        break;   /* hi limit is 1! */
      }
    } /* end of rdp_GLB_DECL_1 */
    scan_test(NULL, RDP_T_26 /* ; */, &GLB_DECL_stop);
    scan_();
     fprintf(ft, "%s %d %d\n", name, INT, val); \
   key = symbol_insert_key(table, &name, sizeof(char*), sizeof(table_data)); \
   table_cast(key)->id     = name; \
   ...
   table_cast(key)->value  = val; \
    ...
    scan_test_set(NULL, &GLB_DECL_stop, &GLB_DECL_stop);
   }
}
